...
Tracking my journey toward Kaggle Grandmaster — competitions, notebooks, and results.

## Results

| Competition | Type | Best CV Score | Notebook |
|---|---|---|---|
...
Each folder is a self-contained writeup for one competition: feature engineering
...
Data Science engineering student, building toward Kaggle Grandmaster status
